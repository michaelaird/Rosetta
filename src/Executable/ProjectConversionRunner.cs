...
namespace Rosetta.Executable
{
    ...
    /// </summary>
    public class ProjectConversionRunner : IRunner
    {
        ...
        protected virtual void InitializeForFileConversion()
        {
            ...
            this.arguments.ProjectPath = this.GetFilePath(this.arguments.ProjectPath);
        ...
        private class ArgumentsValidator : IConversionArgumentsValidator
        {
            ...
            {
                if (this.arguments.ProjectPath == null)
                {
                    throw new ArgumentNullException(nameof(this.arguments.ProjectPath));
                }
